...
on:
  schedule:
    - cron: "0 10 * * *"   # 10:00 UTC daily (6am EDT / 5am EST)
    - cron: "0 14 * * *"   # 14:00 UTC daily (10am EDT / 9am EST) — retry window
  workflow_dispatch:
    inputs:
      force_brief:
    ...
    steps:
      ...
      - name: Commit updated data
        run: |
          ...
          git push || echo "Push failed — transient GitHub error, will retry next scheduled run."
